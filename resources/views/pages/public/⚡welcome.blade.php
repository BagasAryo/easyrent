...
new #[Title('Sewa Mobil Mudah & Terpercaya')] #[Layout('layouts.guest')] class extends Component {
...
<div class="w-full">
    ...
    <section class="relative py-24 overflow-hidden bg-linear-to-b from-zinc-900 to-zinc-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <span class="inline-flex items-center gap-2 px-3 py-1 text-xs font-semibold text-emerald-400 bg-emerald-950/60 border border-emerald-800 rounded-full mb-6">
                <flux:icon icon="sparkles" class="size-4" /> Solusi Rental Mobil Terbaik & Praktis
            </span>
            ...
            <p class="mt-6 text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto">
                Pesan mobil impian Anda secara online dalam hitungan menit. Armada bersih, terawat, dan harga transparan tanpa biaya tersembunyi.
            </p>
            <div class="mt-10 flex flex-wrap items-center justify-center gap-4">
                <flux:button variant="primary" size="base" icon="magnifying-glass" href="#katalog" class="!h-12 !px-6 !text-base">
                    Jelajahi Armada Mobil
                </flux:button>
    ...
    <section class="-mt-12 max-w-5xl mx-auto px-4 relative z-20">
        <div class="p-6 bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl space-y-4">
            <h3 class="text-sm font-semibold text-zinc-300 uppercase tracking-wider">Cari Ketersediaan Mobil</h3>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    <label class="text-xs text-zinc-400 block mb-1">Tanggal Ambil</label>
                    <input type="date" class="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-emerald-500" />
                </div>
                <div>
    ...
    <section id="fitur" class="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-zinc-400 mt-2">Komitmen kami menyajikan pengalaman rental mobil terbaik untuk Anda.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="p-8 rounded-2xl bg-zinc-900/50 border border-zinc-800">
                <div class="size-12 rounded-xl bg-emerald-950/60 border border-emerald-800 flex items-center justify-center text-emerald-400 mb-6">
                    <flux:icon icon="truck" class="size-6" />
                </div>
                <h3 class="text-xl font-bold text-white mb-2">Armada Terawat & Prima</h3>
                <p class="text-zinc-400 text-sm">Semua mobil rutin diservis dan dibersihkan secara steril sebelum diserahkan kepada Anda.</p>
            </div>
            ...
            <div class="p-8 rounded-2xl bg-zinc-900/50 border border-zinc-800">
                ...
                <p class="text-zinc-400 text-sm">Tidak ada biaya tersembunyi. Semua tarif sewa transparan sejak awal pemesanan.</p>
            </div>
            ...
            <div class="p-8 rounded-2xl bg-zinc-900/50 border border-zinc-800">
                ...
                <p class="text-zinc-400 text-sm">Tim customer care kami siap membantu kendala perjalanan Anda kapan saja 24 jam sehari.</p>
            </div>
        </div>
    </section>
    ...
    <section id="katalog" class="py-16 bg-zinc-900/30 border-t border-b border-zinc-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-4">
                <div>
                    <h2 class="text-3xl font-bold text-white">Armada Mobil Populer</h2>
                    <p class="text-zinc-400 mt-2">Pilih mobil yang sesuai dengan kebutuhan perjalanan atau keluarga Anda.</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="rounded-2xl bg-zinc-900 border border-zinc-800 overflow-hidden flex flex-col justify-between">
                    <div class="aspect-video bg-zinc-950 flex items-center justify-center text-zinc-600 relative">
                        ...
                        <span class="absolute top-3 right-3 px-2 py-1 text-xs font-semibold bg-emerald-950 border border-emerald-800 text-emerald-400 rounded-md">Tersedia</span>
                    </div>
