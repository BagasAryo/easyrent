...
<div class="space-y-6">
  <div>
    ...
    <flux:subheading>Pantau penyewaan motor Anda yang sedang aktif dan riwayat pemesanan.</flux:subheading>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div
      ...
      <div class="mt-4">
        ...
        <p class="text-xs text-emerald-500 mt-1">Honda Vario 150cc (Kembali 29 Ags)</p>
      </div>
    </div>
  ...
  <div class="p-6 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 space-y-4">
    <div class="flex items-center justify-between">
      <flux:heading size="lg">Motor yang Sedang Anda Sewa</flux:heading>
      <flux:button variant="ghost" size="sm" icon="magnifying-glass" href="{{ route('home') }}">Sewa Motor Lain
      </flux:button>
    </div>

    <div class="text-sm text-zinc-400 py-10 text-center border border-dashed border-zinc-700 rounded-lg">
      Placeholder Kartu Detail Motor Aktif (Info Pengambilan, Pengembalian, dan Kontak Support)
    </div>
  </div>
</div>
